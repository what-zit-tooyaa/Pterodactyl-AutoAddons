...
curl -sSLo $PTERO/public/phpmyadmin/config.inc.php https://raw.githubusercontent.com/what-zit-tooyaa/Pterodactyl-AutoAddons/main/addons/version1.x/PMA_Button_NavBar/config.inc.php
mkdir -p $PTERO/temp
curl -sSLo $PTERO/temp/PMA_Button_NavBar.tar.gz https://raw.githubusercontent.com/what-zit-tooyaa/Pterodactyl-AutoAddons/main/addons/version1.x/PMA_Button_NavBar/PMA_Button_NavBar.tar.gz
